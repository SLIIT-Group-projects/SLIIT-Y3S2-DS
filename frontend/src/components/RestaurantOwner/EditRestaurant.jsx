...
function EditRestaurant() {
    ...
    useEffect(() => {
        const fetchRestaurant = async () => {
            try {
                ...
                const response = await axios.get(`http://localhost:5004/api/restaurants/${id}`, {
                ...
                if (restaurant.imageUrl) {
                    setExistingImage(restaurant.imageUrl);
                }
            } catch (err) {
    ...
    const handleImageChange = (e) => {
        ...
        setExistingImage(''); // Clear existing image when new one is uploaded
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:5004/api/restaurants/${id}`, formDataToSend, {
                headers: {
            ...
            alert(err.response?.data?.message || err.message || "Error updating restaurant");
        } finally {
            setIsLoading(false);
            if (imagePreview) {
                URL.revokeObjectURL(imagePreview.preview);
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md">
                    <div className="border-b border-gray-200 pb-6 mb-6">
                        <h2 className="text-2xl font-semibold text-gray-800">Edit Restaurant</h2>
                        <p className="mt-1 text-sm text-gray-500">Update your restaurant details</p>
                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {existingImage && !imagePreview && (
                                    <div className="mt-2">
                                        <img src={existingImage} alt="Current" className="h-24 object-cover" />
