                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <button 
                            ...
                            className="w-full bg-orange-500 hover:bg-orange-600 text-white py-4 rounded-full font-medium transition-colors flex items-center justify-center gap-3 text-lg"
                        >
